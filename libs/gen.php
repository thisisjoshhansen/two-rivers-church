...
if( !function_exists('is_emailaddr') ) {
        function is_emailaddr($email) {
                //Regex according to RFC822 for internet text message addresses.
...
if( !function_exists('clear_existing_sessions') ) {
        function clear_existing_sessions() {
